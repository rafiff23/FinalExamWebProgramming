...
@section('content')
    <div class="container col-md-6 mt-4" style="margin-bottom: 5rem">
        ...
        <div class="card shadow mb-4 ">
            ...
            <div class="card-body ">
                <form class="needs-validation" action="../../{{ app()->getLocale() }}/item" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="validationCustom01" class="form-label">{{ __('item_name') }}</label>
                        <input type="text" name="item_name" class="form-control" id="validationCustom01" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input id="body" type="hidden" name="item_desc" class="form-control" required>
                    ...
                    <div>
                        <button class="btn btn-primary" type="submit"> {{ __('add_item') }}</button>
                    </div>
                </form>
            </div>
        </div>
